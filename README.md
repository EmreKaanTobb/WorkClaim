...
- Transaction-safe reservation handling (`SELECT ... FOR UPDATE`)
...
- **Emre Kaan Uzunöz** — Backend (Python), Database (PostgreSQL)  
- **Zafer Burak Togur** — Reservation Screen Logic (Python), UI (PyQt)  
- **Orhan Efe Yalçın** — Reservation Screen Logic (Python), UI (PyQt)  
- **Mert Efe Karayılmaz** — Main Menu Logic (Python), UI (PyQt)  
- **Hasan Yiğit Sarı** — Login & Authentication (Python), UI (PyQt)
